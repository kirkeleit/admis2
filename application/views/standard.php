...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">AdmisSystem2</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="dropdown<?php echo ($this->uri->segment(1) == 'Penger' ? ' active' : '') ?>">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Penger <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><?php echo anchor('/Penger/Resultat','Resultat'); ?></li>
                <li><?php echo anchor('/Penger/Budsjett','Budsjett'); ?></li>
                <li><?php echo anchor('/Penger/Utgifter','Utgifter'); ?></li>
                <li><?php echo anchor('/Penger/Inntekter','Inntekter'); ?></li>
              </ul>
            </li>
    ...
    <p class="footer">Side lastet på <strong>{elapsed_time}</strong> sekunder.</p>
